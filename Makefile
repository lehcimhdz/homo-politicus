...
TEST_SRC = src/Country.cpp src/EventManager.cpp src/Persistence.cpp src/GameOverChecker.cpp src/DecisionSystem.cpp src/FeedbackBuilder.cpp src/MiniYaml.cpp src/ScenarioLoader.cpp src/AchievementTracker.cpp src/steam/SteamBridge.cpp src/steam/WorkshopBridge.cpp src/LeaderLoader.cpp src/ExpressionEvaluator.cpp src/EventLoader.cpp src/Advisor.cpp src/llm/MockProvider.cpp src/llm/AnthropicProvider.cpp src/GameMode.cpp src/Telemetry.cpp src/SuccessorMode.cpp src/IronManMode.cpp src/ModLoader.cpp src/PerfTracker.cpp src/Localization.cpp src/Tutorial.cpp tests/test_main.cpp tests/test_persistence.cpp tests/test_gameover.cpp tests/test_invariants.cpp tests/test_decisions.cpp tests/test_feedback.cpp tests/test_scenario_loader.cpp tests/test_achievements.cpp tests/test_leader_loader.cpp tests/test_expression.cpp tests/test_event_loader.cpp tests/test_advisor.cpp tests/test_miniyaml_list.cpp tests/test_event_loader_file.cpp tests/test_localization.cpp tests/test_persistence_v2.cpp tests/test_achievements_v2.cpp tests/test_tutorial.cpp tests/test_ui_bridge.cpp tests/test_dashboard.cpp tests/test_mapview.cpp tests/test_actionpanel.cpp tests/test_decision_modal.cpp tests/test_audio_system.cpp tests/test_main_menu.cpp tests/test_gameover_screen.cpp tests/test_tutorial_overlay.cpp tests/test_steam_bridge.cpp tests/test_llm_provider.cpp tests/test_game_mode.cpp tests/test_telemetry.cpp tests/test_invariants_extra.cpp tests/test_successor_mode.cpp tests/test_iron_man_mode.cpp tests/test_hotkey_manager.cpp tests/test_mod_loader.cpp tests/test_workshop_bridge.cpp tests/test_locale_parity.cpp tests/test_perf_tracker.cpp src/ui/MainMenu.cpp src/ui/HotkeyManager.cpp src/ui/GameOverScreen.cpp src/ui/TutorialOverlay.cpp src/ui/UIBridge.cpp src/ui/Dashboard.cpp src/ui/MapView.cpp src/ui/ActionPanel.cpp src/ui/DecisionModal.cpp src/ui/AudioSystem.cpp
TEST_BIN = tests_bin
